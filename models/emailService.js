...
class EmailService {
  ...
  async sendPaymentConfirmation(
    ...
    // Destructure relevant information from eventDetails
  ...
  `
    ...
    const mailOptions = {
      ...
      <div style="font-family: Arial, sans-serif; color: #333; padding: 20px; max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 8px;">
        ...
        <p style="font-size: 14px; color: #888; text-align: center;">
          If you have any questions or need further assistance, feel free to reach out to us at <a href="mailto:mindsphere.services@gmail.com
          " style="color: #e4c04b;">mindsphere.services@gmail.com
          </a>.
        </p>
        <p style="font-size: 14px; color: #888; text-align: center;">
          Best regards,<br />The Mindsphere Team
